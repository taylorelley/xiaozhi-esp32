...
uint16_t battCnt;//Blink count
int battLife = 70; //Battery level
...
void PowerManager::Initialize(){
    ...
    // Battery level monitoring pin configuration
    ...
    // Create battery-level GPIO event queue
    gpio_evt_queue = xQueueCreate(2, sizeof(uint32_t));
    // Install battery-level GPIO ISR service
