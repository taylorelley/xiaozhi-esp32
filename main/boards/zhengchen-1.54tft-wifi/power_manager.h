...
private:
    ...
    void ReadBatteryAdcData() {
        ...
        // Check if low-battery threshold reached
        if (adc_values_.size() >= kBatteryAdcDataCount) {
    ...
    void ReadTemperature() {
        ...
        if (abs(temperature - current_temperature_) >= 3.5f) {  // Only trigger the callback if temperature changes by more than 3.5°C
