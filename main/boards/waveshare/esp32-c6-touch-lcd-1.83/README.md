# esp32-c6-touch-lcd-1.83 board

([English](README.md) | [中文](README_zh.md))

This folder contains the board-support code for the **esp32-c6-touch-lcd-1.83** hardware. The original maintainer-provided documentation is in Chinese; see [README_zh.md](README_zh.md) for the full hardware description, pinout, and build notes.
