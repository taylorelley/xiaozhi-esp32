# esp-s3-lcd-ev-board board

([English](README.md) | [中文](README_zh.md))

This folder contains the board-support code for the **esp-s3-lcd-ev-board** hardware. The original maintainer-provided documentation is in Chinese; see [README_zh.md](README_zh.md) for the full hardware description, pinout, and build notes.
