...
def load_base_language(assets_dir):
    """Load the en-US base language data used as a fallback."""
...
def generate_header(lang_code, output_path):
    # Derive project structure from the output path.
    ...
    project_dir = os.path.dirname(main_dir)  # project root
    assets_dir = os.path.join(main_dir, 'assets')

    # Build the language JSON path
    ...
    # Merge strings: en-US as base, user language overrides
    ...
    # Collect sound files: en-US as base, user language overrides
    ...
    # Gather every available sound file
    ...
    # Union base and user sounds; user wins on collision
    ...
    for file in sorted(all_sound_files):
        ...
        # Prefer the current-language sound; fall back to en-US if missing.
    ...
    # Generate shared (common) sound constants
