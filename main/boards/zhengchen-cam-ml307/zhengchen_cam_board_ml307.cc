...
private:
    ...
    void InitializeButtons() {
        ...
        boot_button_.OnDoubleClick([this]() {
            ...
            if (is_first_boot) {
                ESP_LOGI(TAG, "First boot, enabling double-click photo capture");
                ...
                ESP_LOGI(TAG, "Not first boot, disabling double-click photo capture");
                auto& app = Application::GetInstance();
    ...
    void InitializeSt7789Display() {
        ...
        // Initialize the ST7789 LCD driver chip
    ...
    void InitializeCamera() {
        ...
        config.ledc_channel = LEDC_CHANNEL_2;  // LEDC channel selection; used to generate XCLK but unused on S3
        config.ledc_timer = LEDC_TIMER_2; // LEDC timer selection; used to generate XCLK but unused on S3
        ...
        config.pin_sccb_sda = -1;   // -1 means reuse the already-initialized I2C interface
