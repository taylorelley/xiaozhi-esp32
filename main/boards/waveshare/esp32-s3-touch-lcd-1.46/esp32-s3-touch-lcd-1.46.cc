...
// Add a new display class before the waveshare_lcd_1_46 class
...
private:
    ...
    void InitializeTca9554(void) {
        ...
        // ret = esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_0 | IO_EXPANDER_PIN_NUM_1, IO_EXPANDER_INPUT);               // Set pins EXIO0 and EXIO1 to input mode 
        // ret = esp_io_expander_get_level(io_expander, IO_EXPANDER_PIN_NUM_0 | IO_EXPANDER_PIN_NUM_1, &input_level_mask);             // Get the level state of pins EXIO0 and EXIO1,store in input_level_mask

        // ret = esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_2 | IO_EXPANDER_PIN_NUM_3, IO_EXPANDER_OUTPUT);              // Set pins EXIO2 and EXIO3 to output mode
        // ret = esp_io_expander_set_level(io_expander, IO_EXPANDER_PIN_NUM_2 | IO_EXPANDER_PIN_NUM_3, 1);                             // Set pin level to 1
        // ret = esp_io_expander_print_state(io_expander);                                                                             // Print pin state

        ret = esp_io_expander_set_dir(io_expander, IO_EXPANDER_PIN_NUM_0 | IO_EXPANDER_PIN_NUM_1, IO_EXPANDER_OUTPUT);                 // Set pins EXIO0 and EXIO1 to output mode
        ESP_ERROR_CHECK(ret);
