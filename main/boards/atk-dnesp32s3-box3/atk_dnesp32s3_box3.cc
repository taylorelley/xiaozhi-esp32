...
private:
    ...
    void InitializeIoExpander() {
        ...
        ret |= esp_io_expander_set_level(io_exp_handle, XIO_VDDA_3V3_EN, 1);/* Audio power */
        ret |= esp_io_expander_set_level(io_exp_handle, XIO_VBAT_EN, 1);    /* Audio */
        ret |= esp_io_expander_set_level(io_exp_handle, XIO_PA_CTRL, 1);    /* Audio amplifier */
        ret |= esp_io_expander_set_level(io_exp_handle, XIO_LCD_BL, 0);     /* LCDBacklight */
   ...
   void InitializeSt7789Display() {
    ...
    void InitializeCamera() {
        esp_io_expander_set_level(io_exp_handle, XIO_TP_CAM_RESET, 0);  /* Ensure reset */ 
        vTaskDelay(pdMS_TO_TICKS(50));                                  /* Extend the reset hold time */
        esp_io_expander_set_level(io_exp_handle, XIO_TP_CAM_RESET, 1);  /* Release reset */
        ...
        esp_video_init_sccb_config_t sccb_config = {
            ...
            .freq = 100000,             /* SCCB Communication frequency, typically 100kHz */
        };
